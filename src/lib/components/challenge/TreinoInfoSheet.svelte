<script lang="ts">
	...
	const VIMEO_EMBED_SRC =
		'https://player.vimeo.com/video/1200553430?badge=0&autopause=0&player_id=0&app_id=58479';
...
<BottomSheet
	...
	contentFlush
	flushBottom
	title="Como funciona o Protocolo de Treino"
>
	<div class="flex min-h-0 flex-1 flex-col pb-[calc(50px+env(safe-area-inset-bottom))]">
		<div class="relative min-h-0 w-full flex-1">
			<iframe
				...
				title="Tutorial - Protocolo de treino"
			></iframe>
		</div>
	</div>
</BottomSheet>
